...
- The default 2D Focus View prioritizes Act Objective, Recommended Next, and End-Turn Risk; press `0` on standard windows to switch to the full dashboard
- Contextual 2D action footer keeps the core play loop visible, caps the live bar at 10 controls, adds Coach-recommended commands as space allows, and prioritizes endgame, board, then partner routes when pressure makes them relevant
