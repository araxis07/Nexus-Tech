...
Use `--motion-mode reduced` or `--motion-mode off` on `play-2d`, `menu-2d`, and `audit-2d-motion` when you want quieter highlight animation while keeping the same gameplay state and controls.
