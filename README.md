...
- Contextual 2D action footer keeps the core play loop visible, caps the live bar at 12 controls, adds Coach-recommended commands as space allows, and reveals partner, board, and endgame routes when their pressure makes them relevant
...
- The new-game wizard leads with six featured tracks for learning, profit, quality recovery, portfolio scale, debt pressure, and endgame readiness, each with an authored Foundation, Commitment, and Consequence act
