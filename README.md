...
- Built-in `onboarding-visible-window-evidence-sheet` and `validate-onboarding-visible-window-evidence-sheet` commands write and verify the focused 820x620 visible-window onboarding worksheet before compact UI QA begins
