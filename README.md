...
- The title menu (`7 Settings`) and Pause menu (`T Settings`) apply text scale, contrast, and motion immediately across scenes and persist them locally without changing gameplay save slots
