    ...
    return PendingEvent(
        ...
        options=[
            EventOption(
                ...
                description=(
                    "Spend cash to calm premium-reference fragility before the "
                    "roadshow tightens."
                ),
            ),
            EventOption(
    ...
    return PendingEvent(
        ...
        options=[
            EventOption(
                ...
                description=(
                    "Spend cash to reduce channel conflict before closing pressure "
                    "hardens further."
                ),
            ),
            EventOption(
    ...
    return PendingEvent(
        ...
        options=[
            ...
            EventOption(
                ...
                description=(
                    "Protect cash now, but let billing friction and trust drag keep "
                    "rising."
                ),
            ),
        ],
