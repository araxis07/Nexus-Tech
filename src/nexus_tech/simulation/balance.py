...
class BalanceConfig:
    ...
    finance_debt_rollover_min_debt: Decimal = Decimal("1200.00")
    finance_debt_rollover_fee: Decimal = Decimal("260.00")
    finance_debt_rollover_interest_rate_gain: Decimal = Decimal("0.0035")
    finance_debt_rollover_covenant_relief: int = 5
    finance_debt_rollover_pressure_relief: int = 2
    finance_debt_rollover_board_confidence_loss: int = 1
    ...
    event_board_reset_showdown_weight: int = 3
    event_board_reset_showdown_cooldown: int = 7
    event_board_reset_showdown_pressure_threshold: int = 68
    event_board_reset_showdown_reset_pressure_relief: int = 5
    event_board_reset_showdown_reset_risk_relief: int = 6
    event_board_reset_showdown_reset_focus_gain: int = 7
    event_board_reset_showdown_reset_reserve_share_gain: int = 6
    event_board_reset_showdown_reset_gtm_share_loss: int = 6
    event_board_reset_showdown_reset_reputation_loss: int = 2
    event_board_reset_showdown_reset_confidence_gain: int = 2
    event_board_reset_showdown_defy_pressure_gain: int = 5
    event_board_reset_showdown_defy_warning_gain: int = 1
    event_board_reset_showdown_defy_crisis_gain: int = 1
    event_board_reset_showdown_defy_confidence_loss: int = 3
    event_board_reset_execution_plan_weight: int = 3
    event_board_reset_execution_plan_cooldown: int = 7
    event_board_reset_execution_plan_pressure_threshold: int = 70
    event_board_reset_execution_plan_reset_pressure_relief: int = 3
    event_board_reset_execution_plan_reset_risk_relief: int = 4
    event_board_reset_execution_plan_reset_focus_gain: int = 5
    event_board_reset_execution_plan_reset_reserve_share_gain: int = 4
    event_board_reset_execution_plan_reset_gtm_share_loss: int = 4
    event_board_reset_execution_plan_reset_reputation_loss: int = 1
    event_board_reset_execution_plan_reset_confidence_gain: int = 2
    event_board_reset_execution_plan_defy_pressure_gain: int = 4
    event_board_reset_execution_plan_defy_warning_gain: int = 1
    event_board_reset_execution_plan_defy_crisis_gain: int = 1
    event_board_reset_execution_plan_defy_confidence_loss: int = 2
    event_board_reset_operating_cadence_weight: int = 3
    event_board_reset_operating_cadence_cooldown: int = 7
    event_board_reset_operating_cadence_pressure_threshold: int = 72
    event_board_reset_operating_cadence_install_pressure_relief: int = 3
    event_board_reset_operating_cadence_install_risk_relief: int = 3
    event_board_reset_operating_cadence_install_focus_gain: int = 4
    event_board_reset_operating_cadence_install_reserve_share_gain: int = 3
    event_board_reset_operating_cadence_install_gtm_share_loss: int = 3
    event_board_reset_operating_cadence_install_confidence_gain: int = 2
    event_board_reset_operating_cadence_install_score_gain: int = 2
    event_board_reset_operating_cadence_install_reputation_loss: int = 1
    event_board_reset_operating_cadence_slip_pressure_gain: int = 4
    event_board_reset_operating_cadence_slip_warning_gain: int = 1
    event_board_reset_operating_cadence_slip_restructuring_gain: int = 3
    event_board_reset_operating_cadence_slip_confidence_loss: int = 2
    event_board_reset_operating_cadence_slip_crisis_gain: int = 1
    event_board_reset_governance_table_weight: int = 3
    event_board_reset_governance_table_cooldown: int = 7
    event_board_reset_governance_table_pressure_threshold: int = 74
    event_board_reset_governance_table_ratify_pressure_relief: int = 3
    event_board_reset_governance_table_ratify_risk_relief: int = 3
    event_board_reset_governance_table_ratify_focus_gain: int = 4
    event_board_reset_governance_table_ratify_reserve_share_gain: int = 3
    event_board_reset_governance_table_ratify_gtm_share_loss: int = 3
    event_board_reset_governance_table_ratify_confidence_gain: int = 2
    event_board_reset_governance_table_ratify_score_gain: int = 2
    event_board_reset_governance_table_ratify_reputation_loss: int = 1
    event_board_reset_governance_table_stretch_pressure_gain: int = 4
    event_board_reset_governance_table_stretch_warning_gain: int = 1
    event_board_reset_governance_table_stretch_crisis_gain: int = 1
    event_board_reset_governance_table_stretch_restructuring_gain: int = 3
    event_board_reset_governance_table_stretch_confidence_loss: int = 2
    event_board_reset_balance_sheet_treaty_weight: int = 3
    event_board_reset_balance_sheet_treaty_cooldown: int = 7
    event_board_reset_balance_sheet_treaty_pressure_threshold: int = 76
    event_board_reset_balance_sheet_treaty_ratify_pressure_relief: int = 3
    event_board_reset_balance_sheet_treaty_ratify_risk_relief: int = 3
    event_board_reset_balance_sheet_treaty_ratify_focus_gain: int = 4
    event_board_reset_balance_sheet_treaty_ratify_reserve_share_gain: int = 3
    event_board_reset_balance_sheet_treaty_ratify_gtm_share_loss: int = 3
    event_board_reset_balance_sheet_treaty_ratify_confidence_gain: int = 2
    event_board_reset_balance_sheet_treaty_ratify_score_gain: int = 2
    event_board_reset_balance_sheet_treaty_ratify_reputation_loss: int = 1
    event_board_reset_balance_sheet_treaty_stretch_pressure_gain: int = 4
    event_board_reset_balance_sheet_treaty_stretch_warning_gain: int = 1
    event_board_reset_balance_sheet_treaty_stretch_crisis_gain: int = 1
    event_board_reset_balance_sheet_treaty_stretch_restructuring_gain: int = 3
    event_board_reset_balance_sheet_treaty_stretch_confidence_loss: int = 2
    event_board_reset_trust_vote_weight: int = 3
    event_board_reset_trust_vote_cooldown: int = 7
    event_board_reset_trust_vote_pressure_threshold: int = 78
    event_board_reset_trust_vote_ratify_pressure_relief: int = 3
    event_board_reset_trust_vote_ratify_risk_relief: int = 3
    event_board_reset_trust_vote_ratify_focus_gain: int = 4
    event_board_reset_trust_vote_ratify_reserve_share_gain: int = 3
    event_board_reset_trust_vote_ratify_gtm_share_loss: int = 3
    event_board_reset_trust_vote_ratify_confidence_gain: int = 3
    event_board_reset_trust_vote_ratify_score_gain: int = 2
    event_board_reset_trust_vote_ratify_warning_relief: int = 1
    event_board_reset_trust_vote_ratify_reputation_loss: int = 1
    event_board_reset_trust_vote_stretch_pressure_gain: int = 4
    event_board_reset_trust_vote_stretch_warning_gain: int = 1
    event_board_reset_trust_vote_stretch_crisis_gain: int = 1
    event_board_reset_trust_vote_stretch_restructuring_gain: int = 3
    event_board_reset_trust_vote_stretch_confidence_loss: int = 2
    ...
    support_program_priority_queue_age_churn_gain: int = 1
    ...
    support_program_priority_severe_queue_churn_gain: int = 1
    support_program_priority_severe_queue_renewal_loss: int = 1
    ...
    support_program_renewal_sweep_cost: Decimal = Decimal("195.00")
    support_program_renewal_sweep_account_limit: int = 4
    support_program_renewal_sweep_backlog_relief: int = 2
    support_program_renewal_sweep_escalation_relief: int = 1
    support_program_renewal_sweep_ticket_relief: int = 2
    support_program_renewal_sweep_sla_relief: int = 5
    support_program_renewal_sweep_queue_age_relief: int = 2
    support_program_renewal_sweep_support_load_relief: int = 2
    support_program_renewal_sweep_renewal_health_gain: int = 10
    support_program_renewal_sweep_satisfaction_gain: int = 5
    support_program_renewal_sweep_churn_relief: int = 8
    support_program_renewal_sweep_onboarding_health_gain: int = 6
    support_program_renewal_sweep_billing_invoice_relief: int = 12
    support_program_renewal_sweep_billing_payment_relief: int = 12
    support_program_renewal_sweep_billing_dunning_relief: int = 1
    support_program_renewal_sweep_lane_relief: int = 3
    support_program_enterprise_assurance_cost: Decimal = Decimal("230.00")
    support_program_enterprise_assurance_account_limit: int = 3
    support_program_enterprise_assurance_backlog_relief: int = 3
    support_program_enterprise_assurance_escalation_relief: int = 2
    support_program_enterprise_assurance_ticket_relief: int = 4
    support_program_enterprise_assurance_sla_relief: int = 8
    support_program_enterprise_assurance_queue_age_relief: int = 2
    support_program_enterprise_assurance_support_load_relief: int = 3
    support_program_enterprise_assurance_renewal_health_gain: int = 8
    support_program_enterprise_assurance_satisfaction_gain: int = 6
    support_program_enterprise_assurance_churn_relief: int = 6
    support_program_enterprise_assurance_lane_relief: int = 4
    support_program_enterprise_assurance_board_pressure_relief: int = 2
    support_program_billing_stabilization_cost: Decimal = Decimal("210.00")
    support_program_billing_stabilization_account_limit: int = 3
    support_program_billing_stabilization_backlog_relief: int = 2
    support_program_billing_stabilization_escalation_relief: int = 1
    support_program_billing_stabilization_ticket_relief: int = 3
    support_program_billing_stabilization_sla_relief: int = 6
    support_program_billing_stabilization_queue_age_relief: int = 2
    support_program_billing_stabilization_support_load_relief: int = 2
    support_program_billing_stabilization_invoice_relief: int = 14
    support_program_billing_stabilization_payment_relief: int = 14
    support_program_billing_stabilization_dunning_relief: int = 1
    support_program_billing_stabilization_renewal_health_gain: int = 9
    support_program_billing_stabilization_satisfaction_gain: int = 4
    support_program_billing_stabilization_churn_relief: int = 7
    support_program_billing_stabilization_lane_relief: int = 4
    support_program_billing_stabilization_board_pressure_relief: int = 1
    support_program_billing_stabilization_investor_pressure_relief: int = 1
    support_program_onboarding_recovery_cost: Decimal = Decimal("195.00")
    support_program_onboarding_recovery_account_limit: int = 3
    support_program_onboarding_recovery_backlog_relief: int = 2
    support_program_onboarding_recovery_escalation_relief: int = 1
    support_program_onboarding_recovery_ticket_relief: int = 3
    support_program_onboarding_recovery_sla_relief: int = 6
    support_program_onboarding_recovery_queue_age_relief: int = 2
    support_program_onboarding_recovery_support_load_relief: int = 3
    support_program_onboarding_recovery_onboarding_health_gain: int = 12
    support_program_onboarding_recovery_satisfaction_gain: int = 5
    support_program_onboarding_recovery_renewal_health_gain: int = 6
    support_program_onboarding_recovery_churn_relief: int = 5
    support_program_onboarding_recovery_lane_relief: int = 4
    support_program_onboarding_recovery_board_pressure_relief: int = 1
    support_program_onboarding_fast_track_cost: Decimal = Decimal("185.00")
    support_program_onboarding_fast_track_ticket_relief: int = 3
    support_program_onboarding_fast_track_sla_relief: int = 7
    support_program_onboarding_fast_track_queue_age_relief: int = 2
    support_program_onboarding_fast_track_support_load_relief: int = 4
    support_program_onboarding_fast_track_onboarding_health_gain: int = 14
    support_program_onboarding_fast_track_satisfaction_gain: int = 6
    support_program_onboarding_fast_track_renewal_health_gain: int = 7
    support_program_onboarding_fast_track_churn_relief: int = 6
    support_program_onboarding_fast_track_backlog_relief: int = 1
    support_program_onboarding_fast_track_escalation_relief: int = 1
    support_program_onboarding_fast_track_lane_relief: int = 3
    support_program_onboarding_fast_track_board_pressure_relief: int = 1
    support_program_enterprise_queue_reset_cost: Decimal = Decimal("245.00")
    support_program_enterprise_queue_reset_ticket_relief: int = 3
    support_program_enterprise_queue_reset_sla_relief: int = 8
    support_program_enterprise_queue_reset_queue_age_relief: int = 2
    support_program_enterprise_queue_reset_support_load_relief: int = 5
    support_program_enterprise_queue_reset_onboarding_health_gain: int = 4
    support_program_enterprise_queue_reset_satisfaction_gain: int = 7
    support_program_enterprise_queue_reset_renewal_health_gain: int = 8
    support_program_enterprise_queue_reset_churn_relief: int = 6
    support_program_enterprise_queue_reset_backlog_relief: int = 2
    support_program_enterprise_queue_reset_escalation_relief: int = 1
    support_program_enterprise_queue_reset_lane_relief: int = 4
    support_program_enterprise_queue_reset_board_pressure_relief: int = 1
    support_program_enterprise_queue_reset_board_confidence_gain: int = 1
    support_program_white_glove_recovery_cost: Decimal = Decimal("265.00")
    support_program_white_glove_recovery_ticket_relief: int = 4
    support_program_white_glove_recovery_sla_relief: int = 10
    support_program_white_glove_recovery_queue_age_relief: int = 2
    support_program_white_glove_recovery_support_load_relief: int = 6
    support_program_white_glove_recovery_invoice_relief: int = 4
    support_program_white_glove_recovery_payment_relief: int = 4
    support_program_white_glove_recovery_satisfaction_gain: int = 8
    support_program_white_glove_recovery_renewal_health_gain: int = 8
    support_program_white_glove_recovery_churn_relief: int = 7
    support_program_white_glove_recovery_backlog_relief: int = 1
    support_program_white_glove_recovery_escalation_relief: int = 1
    support_program_white_glove_recovery_lane_relief: int = 3
    support_program_white_glove_recovery_board_pressure_relief: int = 1
    support_program_white_glove_recovery_board_confidence_gain: int = 2
    support_program_white_glove_backstop_cost: Decimal = Decimal("255.00")
    support_program_white_glove_backstop_ticket_relief: int = 4
    support_program_white_glove_backstop_sla_relief: int = 12
    support_program_white_glove_backstop_queue_age_relief: int = 4
    support_program_white_glove_backstop_support_load_relief: int = 7
    support_program_white_glove_backstop_renewal_health_gain: int = 5
    support_program_white_glove_backstop_satisfaction_gain: int = 5
    support_program_white_glove_backstop_churn_relief: int = 4
    support_program_white_glove_backstop_backlog_relief: int = 2
    support_program_white_glove_backstop_escalation_relief: int = 1
    support_program_white_glove_backstop_lane_relief: int = 4
    support_program_white_glove_backstop_board_pressure_relief: int = 2
    support_program_white_glove_backstop_board_confidence_gain: int = 2
    support_program_white_glove_backstop_reputation_gain: int = 1
    support_program_white_glove_renewal_guard_cost: Decimal = Decimal("240.00")
    support_program_white_glove_renewal_guard_ticket_relief: int = 3
    support_program_white_glove_renewal_guard_sla_relief: int = 10
    support_program_white_glove_renewal_guard_queue_age_relief: int = 3
    support_program_white_glove_renewal_guard_support_load_relief: int = 6
    support_program_white_glove_renewal_guard_invoice_relief: int = 6
    support_program_white_glove_renewal_guard_payment_relief: int = 6
    support_program_white_glove_renewal_guard_renewal_health_gain: int = 7
    support_program_white_glove_renewal_guard_satisfaction_gain: int = 5
    support_program_white_glove_renewal_guard_churn_relief: int = 5
    support_program_white_glove_renewal_guard_backlog_relief: int = 1
    support_program_white_glove_renewal_guard_escalation_relief: int = 1
    support_program_white_glove_renewal_guard_lane_relief: int = 3
    support_program_white_glove_renewal_guard_board_pressure_relief: int = 1
    support_program_white_glove_renewal_guard_board_confidence_gain: int = 2
    support_program_white_glove_renewal_guard_reputation_gain: int = 1
    support_program_white_glove_reference_ring_cost: Decimal = Decimal("265.00")
    support_program_white_glove_reference_ring_ticket_relief: int = 3
    support_program_white_glove_reference_ring_sla_relief: int = 8
    support_program_white_glove_reference_ring_queue_age_relief: int = 2
    support_program_white_glove_reference_ring_support_load_relief: int = 5
    support_program_white_glove_reference_ring_onboarding_health_gain: int = 3
    support_program_white_glove_reference_ring_renewal_health_gain: int = 6
    support_program_white_glove_reference_ring_satisfaction_gain: int = 6
    support_program_white_glove_reference_ring_expansion_gain: int = 4
    support_program_white_glove_reference_ring_churn_relief: int = 4
    support_program_white_glove_reference_ring_backlog_relief: int = 1
    support_program_white_glove_reference_ring_escalation_relief: int = 1
    support_program_white_glove_reference_ring_lane_relief: int = 3
    support_program_white_glove_reference_ring_board_pressure_relief: int = 1
    support_program_white_glove_reference_ring_board_confidence_gain: int = 2
    support_program_white_glove_reference_ring_board_score_gain: int = 1
    support_program_white_glove_reference_ring_reputation_gain: int = 1
    support_program_white_glove_reference_committee_cost: Decimal = Decimal("295.00")
    support_program_white_glove_reference_committee_ticket_relief: int = 2
    support_program_white_glove_reference_committee_sla_relief: int = 8
    support_program_white_glove_reference_committee_queue_age_relief: int = 2
    support_program_white_glove_reference_committee_support_load_relief: int = 5
    support_program_white_glove_reference_committee_renewal_health_gain: int = 7
    support_program_white_glove_reference_committee_satisfaction_gain: int = 7
    support_program_white_glove_reference_committee_expansion_gain: int = 5
    support_program_white_glove_reference_committee_churn_relief: int = 4
    support_program_white_glove_reference_committee_backlog_relief: int = 1
    support_program_white_glove_reference_committee_escalation_relief: int = 1
    support_program_white_glove_reference_committee_lane_relief: int = 3
    support_program_white_glove_reference_committee_board_pressure_relief: int = 1
    support_program_white_glove_reference_committee_board_confidence_gain: int = 2
    support_program_white_glove_reference_committee_board_score_gain: int = 2
    support_program_white_glove_reference_committee_reputation_gain: int = 1
    support_program_white_glove_reference_committee_investor_pressure_relief: int = 1
    support_program_enterprise_renewal_cabinet_cost: Decimal = Decimal("255.00")
    support_program_enterprise_renewal_cabinet_ticket_relief: int = 2
    support_program_enterprise_renewal_cabinet_sla_relief: int = 9
    support_program_enterprise_renewal_cabinet_queue_age_relief: int = 2
    support_program_enterprise_renewal_cabinet_support_load_relief: int = 5
    support_program_enterprise_renewal_cabinet_onboarding_health_gain: int = 4
    support_program_enterprise_renewal_cabinet_renewal_health_gain: int = 8
    support_program_enterprise_renewal_cabinet_satisfaction_gain: int = 5
    support_program_enterprise_renewal_cabinet_expansion_gain: int = 4
    support_program_enterprise_renewal_cabinet_churn_relief: int = 4
    support_program_enterprise_renewal_cabinet_backlog_relief: int = 1
    support_program_enterprise_renewal_cabinet_escalation_relief: int = 1
    support_program_enterprise_renewal_cabinet_lane_relief: int = 2
    support_program_enterprise_renewal_cabinet_board_pressure_relief: int = 1
    support_program_enterprise_renewal_cabinet_board_confidence_gain: int = 2
    support_program_enterprise_renewal_cabinet_board_score_gain: int = 2
    support_program_enterprise_renewal_cabinet_reputation_gain: int = 1
    support_program_reference_rescue_cost: Decimal = Decimal("235.00")
    support_program_reference_rescue_ticket_relief: int = 3
    support_program_reference_rescue_sla_relief: int = 10
    support_program_reference_rescue_queue_age_relief: int = 2
    support_program_reference_rescue_support_load_relief: int = 4
    support_program_reference_rescue_renewal_health_gain: int = 8
    support_program_reference_rescue_satisfaction_gain: int = 6
    support_program_reference_rescue_onboarding_health_gain: int = 8
    support_program_reference_rescue_invoice_relief: int = 8
    support_program_reference_rescue_payment_relief: int = 8
    support_program_reference_rescue_churn_relief: int = 6
    support_program_reference_rescue_backlog_relief: int = 1
    support_program_reference_rescue_escalation_relief: int = 1
    support_program_reference_rescue_lane_relief: int = 3
    support_program_reference_rescue_board_pressure_relief: int = 1
    support_program_reference_rescue_board_confidence_gain: int = 1
    support_program_reference_rescue_investor_pressure_relief: int = 1
    support_program_enterprise_reference_cycle_cost: Decimal = Decimal("245.00")
    support_program_enterprise_reference_cycle_ticket_relief: int = 2
    support_program_enterprise_reference_cycle_sla_relief: int = 8
    support_program_enterprise_reference_cycle_queue_age_relief: int = 1
    support_program_enterprise_reference_cycle_support_load_relief: int = 4
    support_program_enterprise_reference_cycle_onboarding_health_gain: int = 4
    support_program_enterprise_reference_cycle_renewal_health_gain: int = 10
    support_program_enterprise_reference_cycle_satisfaction_gain: int = 8
    support_program_enterprise_reference_cycle_expansion_gain: int = 5
    support_program_enterprise_reference_cycle_churn_relief: int = 6
    support_program_enterprise_reference_cycle_backlog_relief: int = 1
    support_program_enterprise_reference_cycle_escalation_relief: int = 1
    support_program_enterprise_reference_cycle_lane_relief: int = 2
    support_program_enterprise_reference_cycle_board_pressure_relief: int = 1
    support_program_enterprise_reference_cycle_board_confidence_gain: int = 2
    support_program_enterprise_reference_cycle_score_gain: int = 1
    support_program_enterprise_reference_cycle_reputation_gain: int = 1
    support_program_billing_retention_reset_cost: Decimal = Decimal("225.00")
    support_program_billing_retention_reset_ticket_relief: int = 2
    support_program_billing_retention_reset_sla_relief: int = 8
    support_program_billing_retention_reset_queue_age_relief: int = 1
    support_program_billing_retention_reset_support_load_relief: int = 4
    support_program_billing_retention_reset_invoice_relief: int = 12
    support_program_billing_retention_reset_payment_relief: int = 12
    support_program_billing_retention_reset_dunning_relief: int = 1
    support_program_billing_retention_reset_renewal_health_gain: int = 10
    support_program_billing_retention_reset_satisfaction_gain: int = 6
    support_program_billing_retention_reset_churn_relief: int = 7
    support_program_billing_retention_reset_backlog_relief: int = 1
    support_program_billing_retention_reset_escalation_relief: int = 1
    support_program_billing_retention_reset_lane_relief: int = 2
    support_program_billing_retention_reset_board_pressure_relief: int = 1
    support_program_billing_retention_reset_investor_pressure_relief: int = 1
    support_program_billing_retention_reset_board_confidence_gain: int = 1
    support_program_billing_covenant_reset_cost: Decimal = Decimal("275.00")
    support_program_billing_covenant_reset_ticket_relief: int = 2
    support_program_billing_covenant_reset_sla_relief: int = 7
    support_program_billing_covenant_reset_queue_age_relief: int = 2
    support_program_billing_covenant_reset_support_load_relief: int = 4
    support_program_billing_covenant_reset_invoice_relief: int = 10
    support_program_billing_covenant_reset_payment_relief: int = 10
    support_program_billing_covenant_reset_dunning_relief: int = 1
    support_program_billing_covenant_reset_renewal_health_gain: int = 7
    support_program_billing_covenant_reset_satisfaction_gain: int = 5
    support_program_billing_covenant_reset_churn_relief: int = 5
    support_program_billing_covenant_reset_backlog_relief: int = 1
    support_program_billing_covenant_reset_escalation_relief: int = 1
    support_program_billing_covenant_reset_lane_relief: int = 2
    support_program_billing_covenant_reset_board_pressure_relief: int = 1
    support_program_billing_covenant_reset_investor_pressure_relief: int = 1
    support_program_billing_covenant_reset_covenant_relief: int = 2
    support_program_billing_covenant_reset_board_confidence_gain: int = 1
    ...
    commercial_pressure_revenue_at_risk_value_divisor: Decimal = Decimal("1800.00")
    commercial_pressure_renewal_pressure_value_divisor: Decimal = Decimal("1600.00")
    ...
    partnership_qbr_cost: Decimal = Decimal("165.00")
    partnership_qbr_enablement_gain: int = 9
    partnership_qbr_quality_gain: int = 4
    partnership_qbr_risk_relief: int = 8
    partnership_qbr_conflict_relief: int = 9
    partnership_qbr_rev_share_relief: Decimal = Decimal("0.0050")
    partnership_qbr_hotspot_bonus: int = 2
    partnership_qbr_reseller_board_relief: int = 1
    partnership_qbr_reseller_pressure_relief: int = 1
    partnership_qbr_integration_onboarding_gain: int = 8
    partnership_qbr_integration_support_load_relief: int = 3
    partnership_qbr_marketplace_invoice_relief: int = 12
    partnership_qbr_marketplace_payment_relief: int = 12
    partnership_qbr_marketplace_dunning_relief: int = 1
    partnership_qbr_account_limit: int = 2
    partnership_channel_rebalance_cost: Decimal = Decimal("185.00")
    partnership_channel_rebalance_hotspot_risk_relief: int = 8
    partnership_channel_rebalance_hotspot_conflict_relief: int = 10
    partnership_channel_rebalance_hotspot_revenue_retention_rate: Decimal = Decimal("0.8500")
    partnership_channel_rebalance_hotspot_user_retention_percent: int = 88
    partnership_channel_rebalance_supporting_enablement_gain: int = 6
    partnership_channel_rebalance_supporting_quality_gain: int = 3
    partnership_channel_rebalance_supporting_risk_relief: int = 4
    partnership_channel_rebalance_board_pressure_relief: int = 2
    partnership_channel_rebalance_investor_pressure_relief: int = 1
    partnership_recovery_sprint_cost: Decimal = Decimal("205.00")
    partnership_recovery_sprint_enablement_gain: int = 10
    partnership_recovery_sprint_quality_gain: int = 4
    partnership_recovery_sprint_risk_relief: int = 10
    partnership_recovery_sprint_conflict_relief: int = 12
    partnership_recovery_sprint_rev_share_relief: Decimal = Decimal("0.0075")
    partnership_recovery_sprint_board_pressure_relief: int = 2
    partnership_recovery_sprint_investor_pressure_relief: int = 1
    partnership_recovery_sprint_reseller_satisfaction_gain: int = 4
    partnership_recovery_sprint_reseller_churn_relief: int = 5
    partnership_recovery_sprint_integration_onboarding_gain: int = 10
    partnership_recovery_sprint_integration_support_relief: int = 4
    partnership_recovery_sprint_marketplace_invoice_relief: int = 15
    partnership_recovery_sprint_marketplace_payment_relief: int = 15
    partnership_recovery_sprint_marketplace_dunning_relief: int = 1
    partnership_recovery_sprint_marketplace_renewal_gain: int = 6
    partnership_channel_firebreak_cost: Decimal = Decimal("240.00")
    partnership_channel_firebreak_revenue_retention_rate: Decimal = Decimal("0.7800")
    partnership_channel_firebreak_user_retention_percent: int = 82
    partnership_channel_firebreak_risk_relief: int = 10
    partnership_channel_firebreak_conflict_relief: int = 12
    partnership_channel_firebreak_enablement_gain: int = 8
    partnership_channel_firebreak_board_pressure_relief: int = 2
    partnership_channel_firebreak_investor_pressure_relief: int = 1
    partnership_channel_firebreak_reseller_satisfaction_gain: int = 3
    partnership_channel_firebreak_reseller_churn_relief: int = 4
    partnership_channel_firebreak_integration_onboarding_gain: int = 8
    partnership_channel_firebreak_integration_support_relief: int = 3
    partnership_channel_firebreak_marketplace_invoice_relief: int = 10
    partnership_channel_firebreak_marketplace_payment_relief: int = 10
    partnership_channel_firebreak_marketplace_dunning_relief: int = 1
    partnership_channel_firebreak_marketplace_renewal_gain: int = 4
    partnership_channel_conflict_reset_cost: Decimal = Decimal("255.00")
    partnership_channel_conflict_reset_revenue_retention_rate: Decimal = Decimal("0.8600")
    partnership_channel_conflict_reset_user_retention_percent: int = 88
    partnership_channel_conflict_reset_risk_relief: int = 8
    partnership_channel_conflict_reset_conflict_relief: int = 14
    partnership_channel_conflict_reset_enablement_gain: int = 6
    partnership_channel_conflict_reset_rev_share_penalty: Decimal = Decimal("0.0100")
    partnership_channel_conflict_reset_board_pressure_relief: int = 2
    partnership_channel_conflict_reset_investor_pressure_relief: int = 1
    partnership_channel_conflict_reset_reseller_satisfaction_gain: int = 4
    partnership_channel_conflict_reset_reseller_churn_relief: int = 5
    partnership_channel_conflict_reset_integration_onboarding_gain: int = 6
    partnership_channel_conflict_reset_integration_support_relief: int = 3
    partnership_channel_conflict_reset_marketplace_invoice_relief: int = 8
    partnership_channel_conflict_reset_marketplace_payment_relief: int = 8
    partnership_channel_conflict_reset_marketplace_renewal_gain: int = 4
    partnership_channel_realignment_cost: Decimal = Decimal("235.00")
    partnership_channel_realignment_revenue_retention_rate: Decimal = Decimal("0.9000")
    partnership_channel_realignment_user_retention_percent: int = 90
    partnership_channel_realignment_risk_relief: int = 9
    partnership_channel_realignment_conflict_relief: int = 10
    partnership_channel_realignment_enablement_gain: int = 5
    partnership_channel_realignment_rev_share_penalty: Decimal = Decimal("0.0075")
    partnership_channel_realignment_board_pressure_relief: int = 1
    partnership_channel_realignment_investor_pressure_relief: int = 1
    partnership_channel_realignment_reseller_satisfaction_gain: int = 3
    partnership_channel_realignment_reseller_churn_relief: int = 4
    partnership_channel_realignment_integration_onboarding_gain: int = 4
    partnership_channel_realignment_integration_support_relief: int = 2
    partnership_channel_realignment_marketplace_invoice_relief: int = 6
    partnership_channel_realignment_marketplace_payment_relief: int = 6
    partnership_channel_realignment_marketplace_renewal_gain: int = 3
    partnership_channel_synergy_reset_cost: Decimal = Decimal("275.00")
    partnership_channel_synergy_reset_revenue_retention_rate: Decimal = Decimal("0.9200")
    partnership_channel_synergy_reset_user_retention_percent: int = 92
    partnership_channel_synergy_reset_risk_relief: int = 10
    partnership_channel_synergy_reset_conflict_relief: int = 9
    partnership_channel_synergy_reset_enablement_gain: int = 5
    partnership_channel_synergy_reset_quality_gain: int = 3
    partnership_channel_synergy_reset_rev_share_relief: Decimal = Decimal("0.0060")
    partnership_channel_synergy_reset_board_pressure_relief: int = 1
    partnership_channel_synergy_reset_investor_pressure_relief: int = 1
    partnership_channel_synergy_reset_board_confidence_gain: int = 1
    partnership_channel_synergy_reset_reseller_satisfaction_gain: int = 4
    partnership_channel_synergy_reset_reseller_churn_relief: int = 4
    partnership_channel_synergy_reset_integration_onboarding_gain: int = 5
    partnership_channel_synergy_reset_integration_support_relief: int = 3
    partnership_channel_synergy_reset_marketplace_invoice_relief: int = 5
    partnership_channel_synergy_reset_marketplace_payment_relief: int = 5
    partnership_channel_synergy_reset_marketplace_renewal_gain: int = 4
    partnership_partner_margin_reset_cost: Decimal = Decimal("295.00")
    partnership_partner_margin_reset_revenue_retention_rate: Decimal = Decimal("0.9500")
    partnership_partner_margin_reset_user_retention_percent: int = 95
    partnership_partner_margin_reset_risk_relief: int = 8
    partnership_partner_margin_reset_conflict_relief: int = 8
    partnership_partner_margin_reset_enablement_gain: int = 4
    partnership_partner_margin_reset_quality_gain: int = 2
    partnership_partner_margin_reset_rev_share_relief: Decimal = Decimal("0.0080")
    partnership_partner_margin_reset_board_pressure_relief: int = 1
    partnership_partner_margin_reset_investor_pressure_relief: int = 1
    partnership_partner_margin_reset_board_confidence_gain: int = 2
    partnership_partner_margin_reset_reseller_satisfaction_gain: int = 3
    partnership_partner_margin_reset_reseller_renewal_gain: int = 4
    partnership_partner_margin_reset_integration_onboarding_gain: int = 4
    partnership_partner_margin_reset_integration_support_relief: int = 4
    partnership_partner_margin_reset_marketplace_invoice_relief: int = 6
    partnership_partner_margin_reset_marketplace_payment_relief: int = 6
    partnership_partner_margin_reset_marketplace_renewal_gain: int = 4
    partnership_channel_stability_reset_cost: Decimal = Decimal("230.00")
    partnership_channel_stability_reset_revenue_retention_rate: Decimal = Decimal("0.9600")
    partnership_channel_stability_reset_user_retention_percent: int = 96
    partnership_channel_stability_reset_risk_relief: int = 9
    partnership_channel_stability_reset_conflict_relief: int = 10
    partnership_channel_stability_reset_enablement_gain: int = 5
    partnership_channel_stability_reset_quality_gain: int = 2
    partnership_channel_stability_reset_rev_share_relief: Decimal = Decimal("0.0040")
    partnership_channel_stability_reset_board_pressure_relief: int = 1
    partnership_channel_stability_reset_investor_pressure_relief: int = 1
    partnership_channel_stability_reset_board_confidence_gain: int = 1
    partnership_channel_stability_reset_reseller_satisfaction_gain: int = 4
    partnership_channel_stability_reset_reseller_renewal_gain: int = 5
    partnership_channel_stability_reset_integration_onboarding_gain: int = 5
    partnership_channel_stability_reset_integration_support_relief: int = 4
    partnership_channel_stability_reset_marketplace_invoice_relief: int = 8
    partnership_channel_stability_reset_marketplace_payment_relief: int = 8
    partnership_channel_stability_reset_marketplace_renewal_gain: int = 5
    partnership_reseller_enablement_reset_cost: Decimal = Decimal("235.00")
    partnership_reseller_enablement_reset_revenue_retention_rate: Decimal = Decimal("0.9850")
    partnership_reseller_enablement_reset_user_retention_percent: int = 99
    partnership_reseller_enablement_reset_risk_relief: int = 7
    partnership_reseller_enablement_reset_conflict_relief: int = 6
    partnership_reseller_enablement_reset_enablement_gain: int = 12
    partnership_reseller_enablement_reset_quality_gain: int = 4
    partnership_reseller_enablement_reset_rev_share_relief: Decimal = Decimal("0.0040")
    partnership_reseller_enablement_reset_satisfaction_gain: int = 4
    partnership_reseller_enablement_reset_renewal_gain: int = 4
    partnership_reseller_enablement_reset_board_pressure_relief: int = 1
    partnership_reseller_enablement_reset_investor_pressure_relief: int = 1
    partnership_reseller_enablement_reset_board_confidence_gain: int = 1
    partnership_integration_cutover_reset_cost: Decimal = Decimal("245.00")
    partnership_integration_cutover_reset_revenue_retention_rate: Decimal = Decimal("0.9850")
    partnership_integration_cutover_reset_user_retention_percent: int = 99
    partnership_integration_cutover_reset_risk_relief: int = 8
    partnership_integration_cutover_reset_conflict_relief: int = 7
    partnership_integration_cutover_reset_enablement_gain: int = 11
    partnership_integration_cutover_reset_quality_gain: int = 4
    partnership_integration_cutover_reset_rev_share_relief: Decimal = Decimal("0.0040")
    partnership_integration_cutover_reset_onboarding_gain: int = 6
    partnership_integration_cutover_reset_support_relief: int = 4
    partnership_integration_cutover_reset_renewal_gain: int = 3
    partnership_integration_cutover_reset_board_pressure_relief: int = 1
    partnership_integration_cutover_reset_investor_pressure_relief: int = 1
    partnership_integration_cutover_reset_board_confidence_gain: int = 1
    partnership_marketplace_chargeback_reset_cost: Decimal = Decimal("250.00")
    partnership_marketplace_chargeback_reset_revenue_retention_rate: Decimal = Decimal("0.9800")
    partnership_marketplace_chargeback_reset_user_retention_percent: int = 98
    partnership_marketplace_chargeback_reset_risk_relief: int = 7
    partnership_marketplace_chargeback_reset_conflict_relief: int = 5
    partnership_marketplace_chargeback_reset_enablement_gain: int = 8
    partnership_marketplace_chargeback_reset_quality_gain: int = 4
    partnership_marketplace_chargeback_reset_rev_share_relief: Decimal = Decimal("0.0040")
    partnership_marketplace_chargeback_reset_invoice_relief: int = 10
    partnership_marketplace_chargeback_reset_payment_relief: int = 10
    partnership_marketplace_chargeback_reset_dunning_relief: int = 1
    partnership_marketplace_chargeback_reset_renewal_gain: int = 4
    partnership_marketplace_chargeback_reset_board_pressure_relief: int = 2
    partnership_marketplace_chargeback_reset_investor_pressure_relief: int = 1
    partnership_marketplace_chargeback_reset_board_confidence_gain: int = 1
    ...
    partnership_direct_sales_conflict_account_divisor: int = 2
    partnership_direct_sales_conflict_gtm_share_divisor: int = 20
    ...
    partnership_recovery_rev_share_relief: Decimal = Decimal("0.0025")
    ...
    capital_plan_step_up_reserve_target_step: Decimal = Decimal("900.00")
    capital_plan_step_up_reserve_horizon_gain: int = 1
    capital_plan_step_up_reserve_share_shift: int = 4
    capital_plan_step_up_product_share_shift: int = 1
    capital_plan_step_up_board_pressure_relief: int = 1
    capital_plan_step_up_covenant_relief: int = 1
    capital_plan_step_up_investor_pressure_relief: int = 1
    capital_plan_step_up_board_confidence_gain: int = 1
    capital_plan_harden_financing_posture_cost: Decimal = Decimal("160.00")
    capital_plan_harden_financing_target_step: Decimal = Decimal("650.00")
    capital_plan_harden_financing_horizon_gain: int = 1
    capital_plan_harden_financing_reserve_share_shift: int = 3
    capital_plan_harden_financing_gtm_share_shift: int = 2
    capital_plan_harden_financing_product_share_shift: int = 1
    capital_plan_harden_financing_interest_relief: Decimal = Decimal("0.0010")
    capital_plan_harden_financing_board_pressure_relief: int = 1
    capital_plan_harden_financing_covenant_relief: int = 2
    capital_plan_harden_financing_investor_pressure_relief: int = 1
    capital_plan_harden_financing_board_confidence_gain: int = 2
    capital_plan_refinancing_posture_cost: Decimal = Decimal("145.00")
    capital_plan_refinancing_posture_target_step: Decimal = Decimal("550.00")
    capital_plan_refinancing_posture_horizon_gain: int = 1
    capital_plan_refinancing_posture_reserve_share_shift: int = 3
    capital_plan_refinancing_posture_gtm_share_shift: int = 2
    capital_plan_refinancing_posture_product_share_shift: int = 1
    capital_plan_refinancing_posture_interest_relief: Decimal = Decimal("0.0005")
    capital_plan_refinancing_posture_board_pressure_relief: int = 1
    capital_plan_refinancing_posture_covenant_relief: int = 2
    capital_plan_refinancing_posture_investor_pressure_relief: int = 2
    capital_plan_refinancing_posture_board_confidence_gain: int = 1
    capital_plan_lock_buffer_cost: Decimal = Decimal("220.00")
    capital_plan_lock_buffer_target_step: Decimal = Decimal("900.00")
    capital_plan_lock_buffer_horizon_gain: int = 2
    capital_plan_lock_buffer_reserve_share_shift: int = 4
    capital_plan_lock_buffer_gtm_share_shift: int = 3
    capital_plan_lock_buffer_product_share_shift: int = 1
    capital_plan_lock_buffer_board_pressure_relief: int = 2
    capital_plan_lock_buffer_covenant_relief: int = 2
    capital_plan_lock_buffer_investor_pressure_relief: int = 1
    capital_plan_lock_buffer_board_confidence_gain: int = 2
    capital_plan_covenant_firewall_cost: Decimal = Decimal("300.00")
    capital_plan_covenant_firewall_target_step: Decimal = Decimal("800.00")
    capital_plan_covenant_firewall_horizon_gain: int = 2
    capital_plan_covenant_firewall_reserve_share_shift: int = 6
    capital_plan_covenant_firewall_gtm_share_shift: int = 4
    capital_plan_covenant_firewall_product_share_shift: int = 2
    capital_plan_covenant_firewall_interest_relief: Decimal = Decimal("0.0015")
    capital_plan_covenant_firewall_board_pressure_relief: int = 2
    capital_plan_covenant_firewall_covenant_relief: int = 4
    capital_plan_covenant_firewall_investor_pressure_relief: int = 2
    capital_plan_covenant_firewall_board_confidence_gain: int = 2
    capital_plan_debt_strategy_cost: Decimal = Decimal("360.00")
    capital_plan_debt_strategy_paydown: Decimal = Decimal("320.00")
    capital_plan_debt_strategy_target_step: Decimal = Decimal("700.00")
    capital_plan_debt_strategy_horizon_gain: int = 2
    capital_plan_debt_strategy_reserve_share_shift: int = 5
    capital_plan_debt_strategy_gtm_share_shift: int = 3
    capital_plan_debt_strategy_product_share_shift: int = 2
    capital_plan_debt_strategy_interest_relief: Decimal = Decimal("0.0015")
    capital_plan_debt_strategy_board_pressure_relief: int = 2
    capital_plan_debt_strategy_covenant_relief: int = 5
    capital_plan_debt_strategy_investor_pressure_relief: int = 2
    capital_plan_debt_strategy_board_confidence_gain: int = 2
    capital_plan_growth_firebreak_cost: Decimal = Decimal("280.00")
    capital_plan_growth_firebreak_target_step: Decimal = Decimal("650.00")
    capital_plan_growth_firebreak_horizon_gain: int = 2
    capital_plan_growth_firebreak_reserve_share_shift: int = 6
    capital_plan_growth_firebreak_gtm_share_shift: int = 4
    capital_plan_growth_firebreak_product_share_shift: int = 2
    capital_plan_growth_firebreak_board_pressure_relief: int = 3
    capital_plan_growth_firebreak_governance_risk_relief: int = 4
    capital_plan_growth_firebreak_investor_pressure_relief: int = 2
    capital_plan_growth_firebreak_board_confidence_gain: int = 2
    capital_plan_path_capital_posture_cost: Decimal = Decimal("295.00")
    capital_plan_path_capital_posture_target_step: Decimal = Decimal("700.00")
    capital_plan_path_capital_posture_horizon_gain: int = 2
    capital_plan_path_capital_posture_reserve_share_shift: int = 5
    capital_plan_path_capital_posture_gtm_share_shift: int = 4
    capital_plan_path_capital_posture_product_share_shift: int = 2
    capital_plan_path_capital_posture_board_pressure_relief: int = 2
    capital_plan_path_capital_posture_governance_risk_relief: int = 3
    capital_plan_path_capital_posture_investor_pressure_relief: int = 2
    capital_plan_path_capital_posture_board_confidence_gain: int = 2
    capital_plan_endgame_capital_map_cost: Decimal = Decimal("325.00")
    capital_plan_endgame_capital_map_target_step: Decimal = Decimal("850.00")
    capital_plan_endgame_capital_map_horizon_gain: int = 2
    capital_plan_endgame_capital_map_reserve_share_shift: int = 6
    capital_plan_endgame_capital_map_gtm_share_shift: int = 5
    capital_plan_endgame_capital_map_product_share_shift: int = 1
    capital_plan_endgame_capital_map_board_pressure_relief: int = 2
    capital_plan_endgame_capital_map_governance_risk_relief: int = 3
    capital_plan_endgame_capital_map_investor_pressure_relief: int = 2
    capital_plan_endgame_capital_map_covenant_relief: int = 2
    capital_plan_endgame_capital_map_board_confidence_gain: int = 2
    ...
    finance_planner_white_glove_recovery_value_threshold: Decimal = Decimal("2400.00")
    ...
    event_ipo_audit_committee_weight: int = 5
    event_ipo_audit_committee_cooldown: int = 7
    event_ipo_audit_committee_pressure_threshold: int = 60
    event_ipo_audit_committee_fund_cost: Decimal = Decimal("240.00")
    event_ipo_audit_committee_confidence_gain: int = 4
    event_ipo_audit_committee_score_gain: int = 3
    event_ipo_audit_committee_risk_relief: int = 5
    event_ipo_audit_committee_backlog_relief: int = 2
    event_ipo_audit_committee_delay_pressure_gain: int = 4
    event_ipo_audit_committee_delay_risk_gain: int = 4
    event_ipo_audit_committee_delay_queue_gain: int = 2
    event_ipo_reference_crack_weight: int = 4
    event_ipo_reference_crack_cooldown: int = 7
    event_ipo_reference_crack_pressure_threshold: int = 62
    event_ipo_reference_crack_fund_cost: Decimal = Decimal("250.00")
    event_ipo_reference_crack_confidence_gain: int = 3
    event_ipo_reference_crack_score_gain: int = 2
    event_ipo_reference_crack_pressure_relief: int = 2
    event_ipo_reference_crack_account_health_gain: int = 8
    event_ipo_reference_crack_account_satisfaction_gain: int = 6
    event_ipo_reference_crack_delay_pressure_gain: int = 4
    event_ipo_reference_crack_delay_risk_gain: int = 3
    event_ipo_reference_crack_delay_reputation_loss: int = 1
    event_ipo_listing_window_weight: int = 4
    event_ipo_listing_window_cooldown: int = 7
    event_ipo_listing_window_pressure_threshold: int = 58
    event_ipo_listing_window_certify_cost: Decimal = Decimal("320.00")
    event_ipo_listing_window_certify_confidence_gain: int = 2
    event_ipo_listing_window_certify_score_gain: int = 2
    event_ipo_listing_window_certify_pressure_relief: int = 2
    event_ipo_listing_window_certify_risk_relief: int = 1
    event_ipo_listing_window_accelerate_pressure_gain: int = 3
    event_ipo_listing_window_accelerate_risk_gain: int = 2
    event_ipo_listing_window_accelerate_reputation_gain: int = 2
    event_ipo_governance_lockstep_weight: int = 4
    event_ipo_governance_lockstep_cooldown: int = 7
    event_ipo_governance_lockstep_pressure_threshold: int = 60
    event_ipo_governance_lockstep_lock_cost: Decimal = Decimal("340.00")
    event_ipo_governance_lockstep_confidence_gain: int = 3
    event_ipo_governance_lockstep_score_gain: int = 2
    event_ipo_governance_lockstep_pressure_relief: int = 2
    event_ipo_governance_lockstep_risk_relief: int = 3
    event_ipo_governance_lockstep_warning_relief: int = 1
    event_ipo_governance_lockstep_stretch_pressure_gain: int = 3
    event_ipo_governance_lockstep_stretch_risk_gain: int = 3
    event_ipo_governance_lockstep_stretch_reputation_gain: int = 1
    event_ipo_syndicate_commitment_weight: int = 4
    event_ipo_syndicate_commitment_cooldown: int = 7
    event_ipo_syndicate_commitment_pressure_threshold: int = 60
    event_ipo_syndicate_commitment_anchor_cost: Decimal = Decimal("300.00")
    event_ipo_syndicate_commitment_confidence_gain: int = 3
    event_ipo_syndicate_commitment_score_gain: int = 2
    event_ipo_syndicate_commitment_pressure_relief: int = 2
    event_ipo_syndicate_commitment_risk_relief: int = 2
    event_ipo_syndicate_commitment_reputation_gain: int = 1
    event_ipo_syndicate_commitment_trim_pressure_relief: int = 1
    event_ipo_syndicate_commitment_trim_score_loss: int = 1
    event_ipo_syndicate_commitment_trim_reputation_loss: int = 1
    event_ipo_pricing_committee_weight: int = 4
    event_ipo_pricing_committee_cooldown: int = 7
    event_ipo_pricing_committee_pressure_threshold: int = 62
    event_ipo_pricing_committee_book_cost: Decimal = Decimal("330.00")
    event_ipo_pricing_committee_confidence_gain: int = 3
    event_ipo_pricing_committee_score_gain: int = 2
    event_ipo_pricing_committee_pressure_relief: int = 2
    event_ipo_pricing_committee_risk_relief: int = 2
    event_ipo_pricing_committee_reputation_gain: int = 1
    event_ipo_pricing_committee_defend_pressure_gain: int = 3
    event_ipo_pricing_committee_defend_risk_gain: int = 2
    event_ipo_pricing_committee_defend_reputation_gain: int = 2
    event_ipo_reference_committee_weight: int = 4
    event_ipo_reference_committee_cooldown: int = 7
    event_ipo_reference_committee_pressure_threshold: int = 64
    event_ipo_reference_committee_fund_cost: Decimal = Decimal("320.00")
    event_ipo_reference_committee_confidence_gain: int = 3
    event_ipo_reference_committee_score_gain: int = 2
    event_ipo_reference_committee_pressure_relief: int = 2
    event_ipo_reference_committee_risk_relief: int = 2
    event_ipo_reference_committee_reputation_gain: int = 1
    event_ipo_reference_committee_support_relief: int = 2
    event_ipo_reference_committee_renewal_gain: int = 4
    event_ipo_reference_committee_satisfaction_gain: int = 4
    event_ipo_reference_committee_churn_relief: int = 3
    event_ipo_reference_committee_defer_pressure_gain: int = 3
    event_ipo_reference_committee_defer_risk_gain: int = 2
    event_ipo_reference_committee_defer_reputation_loss: int = 1
    event_ipo_roadshow_lock_weight: int = 4
    event_ipo_roadshow_lock_cooldown: int = 7
    event_ipo_roadshow_lock_pressure_threshold: int = 66
    event_ipo_roadshow_lock_fund_cost: Decimal = Decimal("340.00")
    event_ipo_roadshow_lock_confidence_gain: int = 3
    event_ipo_roadshow_lock_score_gain: int = 2
    event_ipo_roadshow_lock_pressure_relief: int = 2
    event_ipo_roadshow_lock_risk_relief: int = 2
    event_ipo_roadshow_lock_reputation_gain: int = 1
    event_ipo_roadshow_lock_support_relief: int = 2
    event_ipo_roadshow_lock_renewal_gain: int = 4
    event_ipo_roadshow_lock_satisfaction_gain: int = 4
    event_ipo_roadshow_lock_churn_relief: int = 3
    event_ipo_roadshow_lock_stretch_pressure_gain: int = 3
    event_ipo_roadshow_lock_stretch_risk_gain: int = 2
    event_ipo_roadshow_lock_stretch_reputation_loss: int = 1
    event_ipo_bookbuild_corridor_weight: int = 4
    event_ipo_bookbuild_corridor_cooldown: int = 7
    event_ipo_bookbuild_corridor_pressure_threshold: int = 68
    event_ipo_bookbuild_corridor_fund_cost: Decimal = Decimal("360.00")
    event_ipo_bookbuild_corridor_confidence_gain: int = 3
    event_ipo_bookbuild_corridor_score_gain: int = 2
    event_ipo_bookbuild_corridor_pressure_relief: int = 2
    event_ipo_bookbuild_corridor_risk_relief: int = 2
    event_ipo_bookbuild_corridor_reputation_gain: int = 1
    event_ipo_bookbuild_corridor_support_relief: int = 2
    event_ipo_bookbuild_corridor_renewal_gain: int = 4
    event_ipo_bookbuild_corridor_defer_pressure_gain: int = 3
    event_ipo_bookbuild_corridor_defer_risk_gain: int = 2
    event_ipo_bookbuild_corridor_defer_confidence_loss: int = 1
    ...
    event_buyer_reference_check_weight: int = 5
    event_buyer_reference_check_cooldown: int = 7
    event_buyer_reference_check_pressure_threshold: int = 58
    event_buyer_reference_check_fund_cost: Decimal = Decimal("210.00")
    event_buyer_reference_check_confidence_gain: int = 3
    event_buyer_reference_check_partner_risk_relief: int = 6
    event_buyer_reference_check_partner_conflict_relief: int = 6
    event_buyer_reference_check_account_health_gain: int = 6
    event_buyer_reference_check_optionality_reputation_gain: int = 2
    event_buyer_reference_check_optionality_conflict_gain: int = 4
    event_buyer_channel_conflict_review_weight: int = 4
    event_buyer_channel_conflict_review_cooldown: int = 7
    event_buyer_channel_conflict_review_pressure_threshold: int = 60
    event_buyer_channel_conflict_review_terms_cost: Decimal = Decimal("230.00")
    event_buyer_channel_conflict_review_conflict_relief: int = 10
    event_buyer_channel_conflict_review_risk_relief: int = 6
    event_buyer_channel_conflict_review_enablement_gain: int = 4
    event_buyer_channel_conflict_review_rev_share_penalty: Decimal = Decimal("0.0100")
    event_buyer_channel_conflict_review_board_pressure_relief: int = 2
    event_buyer_channel_conflict_review_press_pressure_gain: int = 3
    event_buyer_channel_conflict_review_press_reputation_loss: int = 1
    event_buyer_channel_conflict_review_press_user_loss: int = 4
    event_buyer_term_sheet_weight: int = 4
    event_buyer_term_sheet_cooldown: int = 7
    event_buyer_term_sheet_pressure_threshold: int = 58
    event_buyer_term_sheet_terms_cost: Decimal = Decimal("260.00")
    event_buyer_term_sheet_confidence_gain: int = 2
    event_buyer_term_sheet_score_gain: int = 1
    event_buyer_term_sheet_pressure_relief: int = 2
    event_buyer_term_sheet_conflict_relief: int = 8
    event_buyer_term_sheet_risk_relief: int = 5
    event_buyer_term_sheet_enablement_gain: int = 4
    event_buyer_term_sheet_rev_share_penalty: Decimal = Decimal("0.0075")
    event_buyer_term_sheet_hold_pressure_gain: int = 3
    event_buyer_term_sheet_hold_risk_gain: int = 2
    event_buyer_term_sheet_hold_reputation_loss: int = 1
    event_buyer_term_sheet_hold_user_loss: int = 4
    event_buyer_synergy_map_weight: int = 4
    event_buyer_synergy_map_cooldown: int = 7
    event_buyer_synergy_map_pressure_threshold: int = 60
    event_buyer_synergy_map_publish_cost: Decimal = Decimal("280.00")
    event_buyer_synergy_map_confidence_gain: int = 2
    event_buyer_synergy_map_score_gain: int = 1
    event_buyer_synergy_map_conflict_relief: int = 8
    event_buyer_synergy_map_risk_relief: int = 6
    event_buyer_synergy_map_enablement_gain: int = 5
    event_buyer_synergy_map_support_relief: int = 3
    event_buyer_synergy_map_pressure_relief: int = 2
    event_buyer_synergy_map_optionality_pressure_gain: int = 3
    event_buyer_synergy_map_optionality_risk_gain: int = 2
    event_buyer_synergy_map_optionality_reputation_loss: int = 1
    event_buyer_synergy_map_optionality_user_loss: int = 3
    event_buyer_integration_blueprint_weight: int = 4
    event_buyer_integration_blueprint_cooldown: int = 7
    event_buyer_integration_blueprint_pressure_threshold: int = 60
    event_buyer_integration_blueprint_fund_cost: Decimal = Decimal("270.00")
    event_buyer_integration_blueprint_confidence_gain: int = 2
    event_buyer_integration_blueprint_score_gain: int = 2
    event_buyer_integration_blueprint_pressure_relief: int = 2
    event_buyer_integration_blueprint_conflict_relief: int = 7
    event_buyer_integration_blueprint_risk_relief: int = 6
    event_buyer_integration_blueprint_enablement_gain: int = 4
    event_buyer_integration_blueprint_support_relief: int = 3
    event_buyer_integration_blueprint_hold_pressure_gain: int = 3
    event_buyer_integration_blueprint_hold_risk_gain: int = 2
    event_buyer_integration_blueprint_hold_reputation_loss: int = 1
    event_buyer_operating_memo_weight: int = 4
    event_buyer_operating_memo_cooldown: int = 7
    event_buyer_operating_memo_pressure_threshold: int = 62
    event_buyer_operating_memo_publish_cost: Decimal = Decimal("285.00")
    event_buyer_operating_memo_confidence_gain: int = 2
    event_buyer_operating_memo_score_gain: int = 2
    event_buyer_operating_memo_pressure_relief: int = 2
    event_buyer_operating_memo_conflict_relief: int = 8
    event_buyer_operating_memo_risk_relief: int = 6
    event_buyer_operating_memo_support_relief: int = 3
    event_buyer_operating_memo_hold_pressure_gain: int = 3
    event_buyer_operating_memo_hold_risk_gain: int = 2
    event_buyer_operating_memo_hold_reputation_loss: int = 1
    event_buyer_signing_committee_weight: int = 4
    event_buyer_signing_committee_cooldown: int = 7
    event_buyer_signing_committee_pressure_threshold: int = 64
    event_buyer_signing_committee_staff_cost: Decimal = Decimal("295.00")
    event_buyer_signing_committee_confidence_gain: int = 2
    event_buyer_signing_committee_score_gain: int = 2
    event_buyer_signing_committee_pressure_relief: int = 2
    event_buyer_signing_committee_conflict_relief: int = 7
    event_buyer_signing_committee_risk_relief: int = 6
    event_buyer_signing_committee_enablement_gain: int = 6
    event_buyer_signing_committee_support_relief: int = 2
    event_buyer_signing_committee_renewal_gain: int = 3
    event_buyer_signing_committee_hold_pressure_gain: int = 3
    event_buyer_signing_committee_hold_risk_gain: int = 2
    event_buyer_signing_committee_hold_conflict_gain: int = 4
    event_buyer_close_readiness_weight: int = 4
    event_buyer_close_readiness_cooldown: int = 7
    event_buyer_close_readiness_pressure_threshold: int = 66
    event_buyer_close_readiness_staff_cost: Decimal = Decimal("310.00")
    event_buyer_close_readiness_confidence_gain: int = 2
    event_buyer_close_readiness_score_gain: int = 2
    event_buyer_close_readiness_pressure_relief: int = 2
    event_buyer_close_readiness_conflict_relief: int = 7
    event_buyer_close_readiness_risk_relief: int = 6
    event_buyer_close_readiness_enablement_gain: int = 6
    event_buyer_close_readiness_support_relief: int = 2
    event_buyer_close_readiness_renewal_gain: int = 3
    event_buyer_close_readiness_hold_pressure_gain: int = 3
    event_buyer_close_readiness_hold_risk_gain: int = 2
    event_buyer_close_readiness_hold_conflict_gain: int = 4
    event_buyer_board_alignment_weight: int = 4
    event_buyer_board_alignment_cooldown: int = 7
    event_buyer_board_alignment_pressure_threshold: int = 68
    event_buyer_board_alignment_staff_cost: Decimal = Decimal("325.00")
    event_buyer_board_alignment_confidence_gain: int = 2
    event_buyer_board_alignment_score_gain: int = 2
    event_buyer_board_alignment_pressure_relief: int = 2
    event_buyer_board_alignment_conflict_relief: int = 6
    event_buyer_board_alignment_risk_relief: int = 6
    event_buyer_board_alignment_enablement_gain: int = 6
    event_buyer_board_alignment_renewal_gain: int = 3
    event_buyer_board_alignment_hold_pressure_gain: int = 3
    event_buyer_board_alignment_hold_risk_gain: int = 2
    event_buyer_board_alignment_hold_conflict_gain: int = 4
    ...
    event_independence_cash_crunch_weight: int = 5
    event_independence_cash_crunch_cooldown: int = 7
    event_independence_cash_crunch_pressure_threshold: int = 58
    event_independence_cash_crunch_cut_pressure_relief: int = 2
    event_independence_cash_crunch_cut_investor_relief: int = 1
    event_independence_cash_crunch_cut_reputation_loss: int = 1
    event_independence_cash_crunch_reserve_share_gain: int = 5
    event_independence_cash_crunch_gtm_share_loss: int = 5
    event_independence_cash_crunch_roll_cash_gain: Decimal = Decimal("700.00")
    event_independence_cash_crunch_roll_debt_gain: Decimal = Decimal("700.00")
    event_independence_cash_crunch_roll_interest_gain: Decimal = Decimal("0.0030")
    event_independence_cash_crunch_roll_pressure_gain: int = 3
    event_independence_refinancing_wall_weight: int = 4
    event_independence_refinancing_wall_cooldown: int = 7
    event_independence_refinancing_wall_pressure_threshold: int = 60
    event_independence_refinancing_wall_reserve_share_gain: int = 4
    event_independence_refinancing_wall_gtm_share_loss: int = 4
    event_independence_refinancing_wall_covenant_relief: int = 4
    event_independence_refinancing_wall_pressure_relief: int = 2
    event_independence_refinancing_wall_investor_relief: int = 1
    event_independence_refinancing_wall_reputation_loss: int = 1
    event_independence_refinancing_wall_cash_gain: Decimal = Decimal("650.00")
    event_independence_refinancing_wall_debt_gain: Decimal = Decimal("650.00")
    event_independence_refinancing_wall_interest_gain: Decimal = Decimal("0.0020")
    event_independence_refinancing_wall_pressure_gain: int = 3
    event_independence_refinancing_wall_covenant_gain: int = 3
    event_independence_profit_floor_weight: int = 4
    event_independence_profit_floor_cooldown: int = 7
    event_independence_profit_floor_pressure_threshold: int = 58
    event_independence_profit_floor_reserve_share_gain: int = 4
    event_independence_profit_floor_gtm_share_loss: int = 4
    event_independence_profit_floor_pressure_relief: int = 2
    event_independence_profit_floor_covenant_relief: int = 2
    event_independence_profit_floor_investor_relief: int = 1
    event_independence_profit_floor_confidence_gain: int = 1
    event_independence_profit_floor_reputation_loss: int = 1
    event_independence_profit_floor_cash_gain: Decimal = Decimal("500.00")
    event_independence_profit_floor_debt_gain: Decimal = Decimal("500.00")
    event_independence_profit_floor_interest_gain: Decimal = Decimal("0.0015")
    event_independence_profit_floor_pressure_gain: int = 3
    event_independence_profit_floor_covenant_gain: int = 3
    event_independence_operating_covenant_weight: int = 4
    event_independence_operating_covenant_cooldown: int = 7
    event_independence_operating_covenant_pressure_threshold: int = 60
    event_independence_operating_covenant_reserve_share_gain: int = 3
    event_independence_operating_covenant_gtm_share_loss: int = 3
    event_independence_operating_covenant_pressure_relief: int = 2
    event_independence_operating_covenant_covenant_relief: int = 3
    event_independence_operating_covenant_investor_relief: int = 1
    event_independence_operating_covenant_confidence_gain: int = 1
    event_independence_operating_covenant_reputation_loss: int = 1
    event_independence_operating_covenant_cash_gain: Decimal = Decimal("450.00")
    event_independence_operating_covenant_debt_gain: Decimal = Decimal("450.00")
    event_independence_operating_covenant_interest_gain: Decimal = Decimal("0.0015")
    event_independence_operating_covenant_pressure_gain: int = 3
    event_independence_operating_covenant_covenant_gain: int = 3
    event_independence_buffer_ratchet_weight: int = 4
    event_independence_buffer_ratchet_cooldown: int = 7
    event_independence_buffer_ratchet_pressure_threshold: int = 62
    event_independence_buffer_ratchet_reserve_share_gain: int = 4
    event_independence_buffer_ratchet_gtm_share_loss: int = 4
    event_independence_buffer_ratchet_pressure_relief: int = 2
    event_independence_buffer_ratchet_covenant_relief: int = 2
    event_independence_buffer_ratchet_investor_relief: int = 1
    event_independence_buffer_ratchet_confidence_gain: int = 1
    event_independence_buffer_ratchet_reputation_loss: int = 1
    event_independence_buffer_ratchet_cash_gain: Decimal = Decimal("350.00")
    event_independence_buffer_ratchet_pressure_gain: int = 2
    event_independence_buffer_ratchet_covenant_gain: int = 2
    event_independence_cash_yield_pact_weight: int = 4
    event_independence_cash_yield_pact_cooldown: int = 7
    event_independence_cash_yield_pact_pressure_threshold: int = 64
    event_independence_cash_yield_pact_reserve_share_gain: int = 3
    event_independence_cash_yield_pact_gtm_share_loss: int = 3
    event_independence_cash_yield_pact_pressure_relief: int = 2
    event_independence_cash_yield_pact_covenant_relief: int = 3
    event_independence_cash_yield_pact_investor_relief: int = 1
    event_independence_cash_yield_pact_confidence_gain: int = 1
    event_independence_cash_yield_pact_reputation_loss: int = 1
    event_independence_cash_yield_pact_cash_gain: Decimal = Decimal("420.00")
    event_independence_cash_yield_pact_debt_gain: Decimal = Decimal("420.00")
    event_independence_cash_yield_pact_interest_gain: Decimal = Decimal("0.0010")
    event_independence_cash_yield_pact_pressure_gain: int = 2
    event_independence_cash_yield_pact_covenant_gain: int = 2
    event_independence_treasury_compact_weight: int = 4
    event_independence_treasury_compact_cooldown: int = 7
    event_independence_treasury_compact_pressure_threshold: int = 66
    event_independence_treasury_compact_reserve_share_gain: int = 4
    event_independence_treasury_compact_gtm_share_loss: int = 4
    event_independence_treasury_compact_pressure_relief: int = 2
    event_independence_treasury_compact_covenant_relief: int = 3
    event_independence_treasury_compact_investor_relief: int = 2
    event_independence_treasury_compact_confidence_gain: int = 2
    event_independence_treasury_compact_reputation_loss: int = 1
    event_independence_treasury_compact_cash_gain: Decimal = Decimal("480.00")
    event_independence_treasury_compact_debt_gain: Decimal = Decimal("480.00")
    event_independence_treasury_compact_interest_gain: Decimal = Decimal("0.0010")
    event_independence_treasury_compact_pressure_gain: int = 2
    event_independence_treasury_compact_covenant_gain: int = 2
    event_independence_cash_command_weight: int = 4
    event_independence_cash_command_cooldown: int = 7
    event_independence_cash_command_pressure_threshold: int = 68
    event_independence_cash_command_reserve_share_gain: int = 4
    event_independence_cash_command_gtm_share_loss: int = 4
    event_independence_cash_command_pressure_relief: int = 2
    event_independence_cash_command_covenant_relief: int = 3
    event_independence_cash_command_investor_relief: int = 2
    event_independence_cash_command_confidence_gain: int = 2
    event_independence_cash_command_reputation_loss: int = 1
    event_independence_cash_command_cash_gain: Decimal = Decimal("520.00")
    event_independence_cash_command_debt_gain: Decimal = Decimal("520.00")
    event_independence_cash_command_interest_gain: Decimal = Decimal("0.0010")
    event_independence_cash_command_pressure_gain: int = 2
    event_independence_cash_command_covenant_gain: int = 2
    event_independence_liquidity_charter_weight: int = 4
    event_independence_liquidity_charter_cooldown: int = 7
    event_independence_liquidity_charter_pressure_threshold: int = 70
    event_independence_liquidity_charter_reserve_share_gain: int = 4
    event_independence_liquidity_charter_gtm_share_loss: int = 4
    event_independence_liquidity_charter_pressure_relief: int = 2
    event_independence_liquidity_charter_covenant_relief: int = 3
    event_independence_liquidity_charter_investor_relief: int = 2
    event_independence_liquidity_charter_confidence_gain: int = 2
    event_independence_liquidity_charter_reputation_loss: int = 1
    event_independence_liquidity_charter_cash_gain: Decimal = Decimal("560.00")
    event_independence_liquidity_charter_debt_gain: Decimal = Decimal("560.00")
    event_independence_liquidity_charter_interest_gain: Decimal = Decimal("0.0010")
    event_independence_liquidity_charter_pressure_gain: int = 2
    event_independence_liquidity_charter_covenant_gain: int = 2
    event_channel_concentration_crackdown_weight: int = 4
    event_channel_concentration_crackdown_cooldown: int = 7
    event_channel_concentration_crackdown_dependency_threshold: int = 72
    event_channel_concentration_crackdown_firebreak_cost: Decimal = Decimal("260.00")
    event_channel_concentration_crackdown_firebreak_risk_relief: int = 8
    event_channel_concentration_crackdown_firebreak_conflict_relief: int = 10
    event_channel_concentration_crackdown_firebreak_revenue_retention_rate: Decimal = Decimal(
        "0.8200"
    )
    event_channel_concentration_crackdown_firebreak_user_retention_percent: int = 86
    event_channel_concentration_crackdown_firebreak_enablement_gain: int = 5
    event_channel_concentration_crackdown_firebreak_board_pressure_relief: int = 2
    event_channel_concentration_crackdown_firebreak_investor_relief: int = 1
    event_channel_concentration_crackdown_drag_revenue_retention_rate: Decimal = Decimal("0.7000")
    event_channel_concentration_crackdown_drag_user_retention_percent: int = 72
    event_channel_concentration_crackdown_drag_conflict_gain: int = 4
    event_channel_concentration_crackdown_drag_pressure_gain: int = 3
    event_channel_concentration_crackdown_drag_reputation_loss: int = 1
    event_reseller_enablement_gap_weight: int = 4
    event_reseller_enablement_gap_cooldown: int = 7
    event_reseller_enablement_gap_enablement_threshold: int = 34
    event_reseller_enablement_gap_fund_cost: Decimal = Decimal("190.00")
    event_reseller_enablement_gap_risk_relief: int = 7
    event_reseller_enablement_gap_conflict_relief: int = 6
    event_reseller_enablement_gap_enablement_gain: int = 6
    event_reseller_enablement_gap_satisfaction_gain: int = 4
    event_reseller_enablement_gap_renewal_gain: int = 5
    event_reseller_enablement_gap_board_pressure_relief: int = 1
    event_reseller_enablement_gap_defer_revenue_retention_rate: Decimal = Decimal("0.9200")
    event_reseller_enablement_gap_defer_user_retention_percent: int = 92
    event_reseller_enablement_gap_defer_conflict_gain: int = 3
    event_reseller_enablement_gap_defer_risk_gain: int = 2
    event_reseller_enablement_gap_defer_pressure_gain: int = 2
    event_integration_cutover_risk_weight: int = 4
    event_integration_cutover_risk_cooldown: int = 7
    event_integration_cutover_risk_risk_threshold: int = 52
    event_integration_cutover_risk_staff_cost: Decimal = Decimal("220.00")
    event_integration_cutover_risk_risk_relief: int = 7
    event_integration_cutover_risk_conflict_relief: int = 7
    event_integration_cutover_risk_enablement_gain: int = 5
    event_integration_cutover_risk_onboarding_gain: int = 6
    event_integration_cutover_risk_support_relief: int = 4
    event_integration_cutover_risk_board_pressure_relief: int = 1
    event_integration_cutover_risk_ship_pressure_gain: int = 3
    event_integration_cutover_risk_ship_risk_gain: int = 3
    event_integration_cutover_risk_ship_reputation_loss: int = 1
    event_marketplace_chargeback_wave_weight: int = 4
    event_marketplace_chargeback_wave_cooldown: int = 7
    event_marketplace_chargeback_wave_payment_threshold: int = 22
    event_marketplace_chargeback_wave_ops_cost: Decimal = Decimal("205.00")
    event_marketplace_chargeback_wave_risk_relief: int = 6
    event_marketplace_chargeback_wave_conflict_relief: int = 5
    event_marketplace_chargeback_wave_invoice_relief: int = 12
    event_marketplace_chargeback_wave_payment_relief: int = 12
    event_marketplace_chargeback_wave_renewal_gain: int = 5
    event_marketplace_chargeback_wave_board_pressure_relief: int = 1
    event_marketplace_chargeback_wave_tighten_pressure_gain: int = 2
    event_marketplace_chargeback_wave_tighten_reputation_loss: int = 1
    event_marketplace_chargeback_wave_tighten_renewal_loss: int = 5
    event_reseller_reference_summit_weight: int = 3
    event_reseller_reference_summit_cooldown: int = 7
    event_reseller_reference_summit_dependency_threshold: int = 68
    event_reseller_reference_summit_fund_cost: Decimal = Decimal("210.00")
    event_reseller_reference_summit_risk_relief: int = 6
    event_reseller_reference_summit_conflict_relief: int = 6
    event_reseller_reference_summit_enablement_gain: int = 8
    event_reseller_reference_summit_satisfaction_gain: int = 4
    event_reseller_reference_summit_renewal_gain: int = 4
    event_reseller_reference_summit_board_pressure_relief: int = 1
    event_reseller_reference_summit_reputation_gain: int = 1
    event_reseller_reference_summit_defer_revenue_retention_rate: Decimal = Decimal("0.9400")
    event_reseller_reference_summit_defer_user_retention_percent: int = 94
    event_reseller_reference_summit_defer_conflict_gain: int = 3
    event_reseller_reference_summit_defer_risk_gain: int = 2
    event_reseller_reference_summit_defer_pressure_gain: int = 2
    event_integration_cutover_board_weight: int = 3
    event_integration_cutover_board_cooldown: int = 7
    event_integration_cutover_board_pressure_threshold: int = 60
    event_integration_cutover_board_fund_cost: Decimal = Decimal("230.00")
    event_integration_cutover_board_risk_relief: int = 7
    event_integration_cutover_board_conflict_relief: int = 6
    event_integration_cutover_board_enablement_gain: int = 6
    event_integration_cutover_board_onboarding_gain: int = 6
    event_integration_cutover_board_support_relief: int = 4
    event_integration_cutover_board_board_pressure_relief: int = 1
    event_integration_cutover_board_accept_pressure_gain: int = 3
    event_integration_cutover_board_accept_risk_gain: int = 3
    event_integration_cutover_board_accept_reputation_loss: int = 1
    event_marketplace_dispute_program_weight: int = 3
    event_marketplace_dispute_program_cooldown: int = 7
    event_marketplace_dispute_program_payment_threshold: int = 24
    event_marketplace_dispute_program_fund_cost: Decimal = Decimal("220.00")
    event_marketplace_dispute_program_risk_relief: int = 6
    event_marketplace_dispute_program_conflict_relief: int = 6
    event_marketplace_dispute_program_invoice_relief: int = 10
    event_marketplace_dispute_program_payment_relief: int = 10
    event_marketplace_dispute_program_renewal_gain: int = 4
    event_marketplace_dispute_program_board_pressure_relief: int = 1
    event_marketplace_dispute_program_absorb_pressure_gain: int = 2
    event_marketplace_dispute_program_absorb_reputation_loss: int = 1
    event_marketplace_dispute_program_absorb_renewal_loss: int = 4
    event_reseller_commitment_review_weight: int = 3
    event_reseller_commitment_review_cooldown: int = 7
    event_reseller_commitment_review_dependency_threshold: int = 70
    event_reseller_commitment_review_fund_cost: Decimal = Decimal("220.00")
    event_reseller_commitment_review_risk_relief: int = 6
    event_reseller_commitment_review_conflict_relief: int = 6
    event_reseller_commitment_review_enablement_gain: int = 7
    event_reseller_commitment_review_satisfaction_gain: int = 4
    event_reseller_commitment_review_renewal_gain: int = 4
    event_reseller_commitment_review_board_pressure_relief: int = 1
    event_reseller_commitment_review_confidence_gain: int = 1
    event_reseller_commitment_review_defer_revenue_retention_rate: Decimal = Decimal("0.9450")
    event_reseller_commitment_review_defer_user_retention_percent: int = 95
    event_reseller_commitment_review_defer_conflict_gain: int = 3
    event_reseller_commitment_review_defer_risk_gain: int = 3
    event_reseller_commitment_review_defer_pressure_gain: int = 2
    event_reseller_margin_council_weight: int = 3
    event_reseller_margin_council_cooldown: int = 7
    event_reseller_margin_council_dependency_threshold: int = 72
    event_reseller_margin_council_fund_cost: Decimal = Decimal("230.00")
    event_reseller_margin_council_risk_relief: int = 6
    event_reseller_margin_council_conflict_relief: int = 6
    event_reseller_margin_council_enablement_gain: int = 6
    event_reseller_margin_council_satisfaction_gain: int = 4
    event_reseller_margin_council_renewal_gain: int = 4
    event_reseller_margin_council_board_pressure_relief: int = 1
    event_reseller_margin_council_confidence_gain: int = 1
    event_reseller_margin_council_defer_revenue_retention_rate: Decimal = Decimal("0.9450")
    event_reseller_margin_council_defer_user_retention_percent: int = 95
    event_reseller_margin_council_defer_conflict_gain: int = 3
    event_reseller_margin_council_defer_risk_gain: int = 3
    event_reseller_margin_council_defer_pressure_gain: int = 2
    event_reseller_pipeline_cadence_weight: int = 3
    event_reseller_pipeline_cadence_cooldown: int = 7
    event_reseller_pipeline_cadence_dependency_threshold: int = 74
    event_reseller_pipeline_cadence_fund_cost: Decimal = Decimal("240.00")
    event_reseller_pipeline_cadence_risk_relief: int = 6
    event_reseller_pipeline_cadence_conflict_relief: int = 6
    event_reseller_pipeline_cadence_enablement_gain: int = 6
    event_reseller_pipeline_cadence_satisfaction_gain: int = 4
    event_reseller_pipeline_cadence_renewal_gain: int = 4
    event_reseller_pipeline_cadence_board_pressure_relief: int = 1
    event_reseller_pipeline_cadence_confidence_gain: int = 1
    event_reseller_pipeline_cadence_defer_revenue_retention_rate: Decimal = Decimal("0.9450")
    event_reseller_pipeline_cadence_defer_user_retention_percent: int = 95
    event_reseller_pipeline_cadence_defer_conflict_gain: int = 3
    event_reseller_pipeline_cadence_defer_risk_gain: int = 3
    event_reseller_pipeline_cadence_defer_pressure_gain: int = 2
    event_integration_release_cutline_weight: int = 3
    event_integration_release_cutline_cooldown: int = 7
    event_integration_release_cutline_pressure_threshold: int = 62
    event_integration_release_cutline_fund_cost: Decimal = Decimal("235.00")
    event_integration_release_cutline_risk_relief: int = 7
    event_integration_release_cutline_conflict_relief: int = 6
    event_integration_release_cutline_enablement_gain: int = 7
    event_integration_release_cutline_onboarding_gain: int = 5
    event_integration_release_cutline_support_relief: int = 4
    event_integration_release_cutline_board_pressure_relief: int = 1
    event_integration_release_cutline_confidence_gain: int = 1
    event_integration_release_cutline_accept_pressure_gain: int = 3
    event_integration_release_cutline_accept_risk_gain: int = 3
    event_integration_release_cutline_accept_reputation_loss: int = 1
    event_integration_support_bridge_weight: int = 3
    event_integration_support_bridge_cooldown: int = 7
    event_integration_support_bridge_pressure_threshold: int = 64
    event_integration_support_bridge_fund_cost: Decimal = Decimal("245.00")
    event_integration_support_bridge_risk_relief: int = 7
    event_integration_support_bridge_conflict_relief: int = 6
    event_integration_support_bridge_enablement_gain: int = 7
    event_integration_support_bridge_onboarding_gain: int = 5
    event_integration_support_bridge_support_relief: int = 4
    event_integration_support_bridge_board_pressure_relief: int = 1
    event_integration_support_bridge_confidence_gain: int = 1
    event_integration_support_bridge_accept_pressure_gain: int = 3
    event_integration_support_bridge_accept_risk_gain: int = 3
    event_integration_support_bridge_accept_reputation_loss: int = 1
    event_integration_go_live_shield_weight: int = 3
    event_integration_go_live_shield_cooldown: int = 7
    event_integration_go_live_shield_pressure_threshold: int = 66
    event_integration_go_live_shield_fund_cost: Decimal = Decimal("255.00")
    event_integration_go_live_shield_risk_relief: int = 7
    event_integration_go_live_shield_conflict_relief: int = 6
    event_integration_go_live_shield_enablement_gain: int = 7
    event_integration_go_live_shield_onboarding_gain: int = 5
    event_integration_go_live_shield_support_relief: int = 4
    event_integration_go_live_shield_board_pressure_relief: int = 1
    event_integration_go_live_shield_confidence_gain: int = 1
    event_integration_go_live_shield_accept_pressure_gain: int = 3
    event_integration_go_live_shield_accept_risk_gain: int = 3
    event_integration_go_live_shield_accept_reputation_loss: int = 1
    event_marketplace_refund_charter_weight: int = 3
    event_marketplace_refund_charter_cooldown: int = 7
    event_marketplace_refund_charter_payment_threshold: int = 26
    event_marketplace_refund_charter_fund_cost: Decimal = Decimal("225.00")
    event_marketplace_refund_charter_risk_relief: int = 6
    event_marketplace_refund_charter_conflict_relief: int = 6
    event_marketplace_refund_charter_invoice_relief: int = 9
    event_marketplace_refund_charter_payment_relief: int = 9
    event_marketplace_refund_charter_renewal_gain: int = 4
    event_marketplace_refund_charter_board_pressure_relief: int = 1
    event_marketplace_refund_charter_confidence_gain: int = 1
    event_marketplace_refund_charter_absorb_pressure_gain: int = 2
    event_marketplace_refund_charter_absorb_reputation_loss: int = 1
    event_marketplace_refund_charter_absorb_renewal_loss: int = 4
    event_marketplace_trust_reset_weight: int = 3
    event_marketplace_trust_reset_cooldown: int = 7
    event_marketplace_trust_reset_payment_threshold: int = 28
    event_marketplace_trust_reset_fund_cost: Decimal = Decimal("250.00")
    event_marketplace_trust_reset_risk_relief: int = 8
    event_marketplace_trust_reset_conflict_relief: int = 7
    event_marketplace_trust_reset_invoice_relief: int = 8
    event_marketplace_trust_reset_payment_relief: int = 8
    event_marketplace_trust_reset_renewal_gain: int = 5
    event_marketplace_trust_reset_board_pressure_relief: int = 1
    event_marketplace_trust_reset_confidence_gain: int = 1
    event_marketplace_trust_reset_absorb_pressure_gain: int = 3
    event_marketplace_trust_reset_absorb_reputation_loss: int = 1
    event_marketplace_trust_reset_absorb_renewal_loss: int = 3
    event_marketplace_policy_appeal_weight: int = 3
    event_marketplace_policy_appeal_cooldown: int = 7
    event_marketplace_policy_appeal_payment_threshold: int = 30
    event_marketplace_policy_appeal_fund_cost: Decimal = Decimal("260.00")
    event_marketplace_policy_appeal_risk_relief: int = 8
    event_marketplace_policy_appeal_conflict_relief: int = 7
    event_marketplace_policy_appeal_invoice_relief: int = 8
    event_marketplace_policy_appeal_payment_relief: int = 8
    event_marketplace_policy_appeal_renewal_gain: int = 5
    event_marketplace_policy_appeal_board_pressure_relief: int = 1
    event_marketplace_policy_appeal_confidence_gain: int = 1
    event_marketplace_policy_appeal_absorb_pressure_gain: int = 3
    event_marketplace_policy_appeal_absorb_reputation_loss: int = 1
    event_marketplace_policy_appeal_absorb_renewal_loss: int = 3
