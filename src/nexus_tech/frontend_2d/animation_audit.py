...
_SCENE_MOTION_PROFILES: tuple[tuple[str, str, int], ...] = (
    ...
    ("title_slots", "save browser", 5),
    ("title_archives", "archive browser", 5),
    ("title_wizard", "new-game wizard", 5),
    ("title_settings", "title settings", 5),
    ("title_slot_detail", "save-slot detail", 5),
    ("title_delete_confirmation", "delete confirmation", 5),
    ("title_text_input", "title text input", 5),
    ...
    ("run_panel_team", "team workspace", 7),
    ("run_panel_finance", "finance workspace", 7),
    ("run_panel_customers", "customer workspace", 7),
    ("run_panel_partnerships", "partnership workspace", 7),
    ("run_panel_board", "board workspace", 7),
    ("run_panel_pipeline", "pipeline workspace", 7),
    ("run_panel_report", "report workspace", 7),
    ("run_inspector_team", "team inspector", 9),
    ("run_inspector_finance", "finance inspector", 9),
    ("run_inspector_customers", "customer inspector", 9),
    ("run_inspector_partnerships", "partnership inspector", 9),
    ("run_inspector_board", "board inspector", 9),
    ("run_inspector_report", "report inspector", 9),
    ("run_inspector_endgame", "endgame inspector", 10),
    ("run_help", "help overlay", 7),
    ("run_pause", "pause overlay", 7),
    ("run_pause_settings", "pause settings", 7),
    ("run_text_input", "run text input", 8),
...
_REQUIRED_SCENE_LAYERS: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ...
    (
        ...
        ("transition", "motion-pulses", "overlay-transition", "help"),
    ),
    (
        "run_endgame_board",
