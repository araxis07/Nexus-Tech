    ...
    try:
        ...
        with TemporaryDirectory(prefix="nexus-tech-motion-audit-") as tmpdir:
            ...
            for width, height in sizes:
                ...
                actor_timeline_active_count += int(run_scene.inspector_actor_active())
                actor_timeline_disabled_count += int(not run_scene.inspector_actor_active())
                sprite_clips_active_count += int(run_scene.inspector_actor_active())
                ...
                actor_timeline_disabled_count += int(not run_scene.endgame_actor_active())
                sprite_clips_active_count += int(run_scene.endgame_actor_active())
                sprite_clips_disabled_count += int(not run_scene.endgame_actor_active())
                ...
                actor_timeline_active_count += int(title_scene.actor_timeline_active())
                actor_timeline_disabled_count += int(not title_scene.actor_timeline_active())
                sprite_clips_active_count += int(title_scene.sprite_clips_active())
                ...
                actor_timeline_active_count += int(review_scene.actor_timeline_active())
                actor_timeline_disabled_count += int(not review_scene.actor_timeline_active())
