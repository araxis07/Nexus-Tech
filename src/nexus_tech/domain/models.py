...
class TurnAction(StrEnum):
    ...
    DEBT_ROLLOVER = "debt_rollover"
    REBALANCE_CAPITAL = "rebalance_capital"
    RAISE_RESERVE_TARGET = "raise_reserve_target"
    ...
    RUN_ACCOUNT_RESCUE = "run_account_rescue"
    RUN_LANE_RECOVERY = "run_lane_recovery"
    RUN_RENEWAL_SWEEP = "run_renewal_sweep"
    RUN_ENTERPRISE_ASSURANCE = "run_enterprise_assurance"
    RUN_BILLING_STABILIZATION = "run_billing_stabilization"
    RUN_ONBOARDING_RECOVERY = "run_onboarding_recovery"
    RUN_ONBOARDING_FAST_TRACK = "run_onboarding_fast_track"
    RUN_ENTERPRISE_QUEUE_RESET = "run_enterprise_queue_reset"
    RUN_WHITE_GLOVE_RECOVERY = "run_white_glove_recovery"
    RUN_WHITE_GLOVE_BACKSTOP = "run_white_glove_backstop"
    RUN_WHITE_GLOVE_RENEWAL_GUARD = "run_white_glove_renewal_guard"
    RUN_WHITE_GLOVE_REFERENCE_RING = "run_white_glove_reference_ring"
    RUN_WHITE_GLOVE_REFERENCE_COMMITTEE = "run_white_glove_reference_committee"
    RUN_WHITE_GLOVE_ESCALATION_CELL = "run_white_glove_escalation_cell"
    RUN_WHITE_GLOVE_REFERENCE_BUREAU = "run_white_glove_reference_bureau"
    RUN_WHITE_GLOVE_REFERENCE_EXCHANGE = "run_white_glove_reference_exchange"
    RUN_REFERENCE_RESCUE = "run_reference_rescue"
    RUN_ENTERPRISE_REFERENCE_CYCLE = "run_enterprise_reference_cycle"
    RUN_ENTERPRISE_RENEWAL_CABINET = "run_enterprise_renewal_cabinet"
    RUN_ENTERPRISE_COMMITMENT_BOARD = "run_enterprise_commitment_board"
    RUN_ENTERPRISE_REFERENCE_CHAMBER = "run_enterprise_reference_chamber"
    RUN_ENTERPRISE_REFERENCE_FORUM = "run_enterprise_reference_forum"
    RUN_ENTERPRISE_REFERENCE_LATTICE = "run_enterprise_reference_lattice"
    RUN_ENTERPRISE_REFERENCE_SUMMIT = "run_enterprise_reference_summit"
    RUN_ENTERPRISE_REFERENCE_DIRECTORATE = "run_enterprise_reference_directorate"
    RUN_ENTERPRISE_REFERENCE_SECRETARIAT = "run_enterprise_reference_secretariat"
    RUN_ENTERPRISE_REFERENCE_AUTHORITY = "run_enterprise_reference_authority"
    RUN_ENTERPRISE_REFERENCE_COMMISSION = "run_enterprise_reference_commission"
    RUN_ENTERPRISE_REFERENCE_OVERSIGHT = "run_enterprise_reference_oversight"
    RUN_ENTERPRISE_REFERENCE_COUNCIL = "run_enterprise_reference_council"
    RUN_BILLING_RETENTION_RESET = "run_billing_retention_reset"
    RUN_BILLING_COVENANT_RESET = "run_billing_covenant_reset"
    RUN_BILLING_DISPUTE_DESK = "run_billing_dispute_desk"
    RUN_BILLING_DISPUTE_CABINET = "run_billing_dispute_cabinet"
    RUN_BILLING_COLLECTION_BRIDGE = "run_billing_collection_bridge"
    RUN_BILLING_COLLECTION_OFFICE = "run_billing_collection_office"
    RUN_BILLING_SETTLEMENT_BOARD = "run_billing_settlement_board"
    RUN_BILLING_CASH_WAR_ROOM = "run_billing_cash_war_room"
    RUN_BILLING_LIQUIDITY_COMMAND = "run_billing_liquidity_command"
    RUN_BILLING_LIQUIDITY_SUMMIT = "run_billing_liquidity_summit"
    RUN_BILLING_LIQUIDITY_DIRECTORATE = "run_billing_liquidity_directorate"
    RUN_BILLING_LIQUIDITY_SECRETARIAT = "run_billing_liquidity_secretariat"
    RUN_BILLING_LIQUIDITY_AUTHORITY = "run_billing_liquidity_authority"
    RUN_BILLING_LIQUIDITY_COMMISSION = "run_billing_liquidity_commission"
    RUN_BILLING_LIQUIDITY_OVERSIGHT = "run_billing_liquidity_oversight"
    RUN_BILLING_LIQUIDITY_COUNCIL = "run_billing_liquidity_council"
    RUN_ONBOARDING_CONTROL_TOWER = "run_onboarding_control_tower"
    RUN_ONBOARDING_LAUNCH_CELL = "run_onboarding_launch_cell"
    RUN_ONBOARDING_ADOPTION_HUB = "run_onboarding_adoption_hub"
    RUN_ONBOARDING_STABILITY_BOARD = "run_onboarding_stability_board"
    RUN_ONBOARDING_RETENTION_MESH = "run_onboarding_retention_mesh"
    RUN_ONBOARDING_ASSURANCE_GRID = "run_onboarding_assurance_grid"
    RUN_ONBOARDING_DURABILITY_MESH = "run_onboarding_durability_mesh"
    RUN_ONBOARDING_CONTINUITY_LATTICE = "run_onboarding_continuity_lattice"
    RUN_ONBOARDING_CONTINUITY_BUREAU = "run_onboarding_continuity_bureau"
    RUN_ONBOARDING_CONTINUITY_SECRETARIAT = "run_onboarding_continuity_secretariat"
    RUN_ONBOARDING_CONTINUITY_AUTHORITY = "run_onboarding_continuity_authority"
    RUN_ONBOARDING_CONTINUITY_COMMISSION = "run_onboarding_continuity_commission"
    RUN_ONBOARDING_CONTINUITY_OVERSIGHT = "run_onboarding_continuity_oversight"
    RUN_ONBOARDING_CONTINUITY_COUNCIL = "run_onboarding_continuity_council"
    RUN_ENTERPRISE_LANE_MESH = "run_enterprise_lane_mesh"
    RUN_BILLING_LANE_MESH = "run_billing_lane_mesh"
    RUN_ONBOARDING_LANE_MESH = "run_onboarding_lane_mesh"
    RUN_WHITE_GLOVE_LANE_MESH = "run_white_glove_lane_mesh"
    RUN_ENTERPRISE_REFERENCE_WATCH = "run_enterprise_reference_watch"
    RUN_BILLING_RENEWAL_WATCH = "run_billing_renewal_watch"
    RUN_ONBOARDING_GO_LIVE_WATCH = "run_onboarding_go_live_watch"
    RUN_WHITE_GLOVE_RETENTION_WATCH = "run_white_glove_retention_watch"
    TRAIN_EMPLOYEE = "train_employee"
    PROMOTE_EMPLOYEE = "promote_employee"
    RUN_COMP_REVIEW = "run_comp_review"
    RUN_SUCCESSION_REVIEW = "run_succession_review"
    ...
    RUN_CHANNEL_QBR = "run_channel_qbr"
    REBALANCE_CHANNEL_MIX = "rebalance_channel_mix"
    RUN_PARTNER_RECOVERY_SPRINT = "run_partner_recovery_sprint"
    RUN_CHANNEL_FIREBREAK = "run_channel_firebreak"
    RUN_CHANNEL_CONFLICT_RESET = "run_channel_conflict_reset"
    RUN_CHANNEL_REALIGNMENT = "run_channel_realignment"
    RUN_CHANNEL_SYNERGY_RESET = "run_channel_synergy_reset"
    RUN_PARTNER_MARGIN_RESET = "run_partner_margin_reset"
    RUN_CHANNEL_STABILITY_RESET = "run_channel_stability_reset"
    RUN_CHANNEL_DEPENDENCY_RESET = "run_channel_dependency_reset"
    RUN_CHANNEL_CONFIDENCE_FIREWALL = "run_channel_confidence_firewall"
    RUN_CHANNEL_DURABILITY_MESH = "run_channel_durability_mesh"
    RUN_CHANNEL_CONFLICT_LATTICE = "run_channel_conflict_lattice"
    RUN_CHANNEL_RESILIENCE_GRID = "run_channel_resilience_grid"
    RUN_CHANNEL_CONTINUITY_MATRIX = "run_channel_continuity_matrix"
    RUN_CHANNEL_ASSURANCE_COVENANT = "run_channel_assurance_covenant"
    RUN_CHANNEL_DURABILITY_STATUTE = "run_channel_durability_statute"
    RUN_CHANNEL_DURABILITY_MANDATE = "run_channel_durability_mandate"
    RUN_CHANNEL_DURABILITY_COMMISSION = "run_channel_durability_commission"
    RUN_CHANNEL_DURABILITY_OVERSIGHT = "run_channel_durability_oversight"
    RUN_CHANNEL_DURABILITY_COUNCIL = "run_channel_durability_council"
    RUN_RESELLER_ENABLEMENT_RESET = "run_reseller_enablement_reset"
    RUN_INTEGRATION_CUTOVER_RESET = "run_integration_cutover_reset"
    RUN_MARKETPLACE_CHARGEBACK_RESET = "run_marketplace_chargeback_reset"
    RENEGOTIATE_PARTNERSHIP = "renegotiate_partnership"
    REACTIVATE_PARTNERSHIP = "reactivate_partnership"
    PAUSE_PARTNERSHIP = "pause_partnership"
    REVIEW_PARTNERSHIPS = "review_partnerships"
    SET_CAPITAL_PLAN = "set_capital_plan"
    SET_REFINANCING_POSTURE = "set_refinancing_posture"
    SET_COVENANT_FIREWALL = "set_covenant_firewall"
    SET_DEBT_STRATEGY = "set_debt_strategy"
    SET_GROWTH_FIREBREAK = "set_growth_firebreak"
    SET_PATH_CAPITAL_POSTURE = "set_path_capital_posture"
    SET_ENDGAME_CAPITAL_MAP = "set_endgame_capital_map"
    SET_EXIT_READINESS_BUFFER = "set_exit_readiness_buffer"
    SET_TERMINAL_LIQUIDITY_CONTROLS = "set_terminal_liquidity_controls"
    SET_CAPITAL_REALLOCATION_GRID = "set_capital_reallocation_grid"
    SET_PATH_CONTROL_MATRIX = "set_path_control_matrix"
    SET_PATH_RESILIENCE_GRID = "set_path_resilience_grid"
    SET_BALANCE_SHEET_RECOVERY_MESH = "set_balance_sheet_recovery_mesh"
    SET_TERMINAL_RECOVERY_LATTICE = "set_terminal_recovery_lattice"
    SET_TERMINAL_CONTINUITY_MATRIX = "set_terminal_continuity_matrix"
    SET_TERMINAL_RESILIENCE_COVENANT = "set_terminal_resilience_covenant"
    SET_TERMINAL_SOLVENCY_STATUTE = "set_terminal_solvency_statute"
    SET_TERMINAL_SOLVENCY_MANDATE = "set_terminal_solvency_mandate"
    SET_TERMINAL_SOLVENCY_COMMISSION = "set_terminal_solvency_commission"
    SET_TERMINAL_SOLVENCY_OVERSIGHT = "set_terminal_solvency_oversight"
    SET_TERMINAL_SOLVENCY_COUNCIL = "set_terminal_solvency_council"
    SET_PATH_CASH_WATERFALL = "set_path_cash_waterfall"
    SET_BOARD_RESET_CONTINGENCY_BUFFER = "set_board_reset_contingency_buffer"
    STEP_UP_RESERVE_DISCIPLINE = "step_up_reserve_discipline"
    HARDEN_FINANCING_POSTURE = "harden_financing_posture"
    LOCK_CAPITAL_BUFFER = "lock_capital_buffer"
