...
- Version: `0.135.0`
- Focus: 2D actor/sprite timeline, blocked-action feedback, CI-backed animation gates, automated actor-readability, visual-fatigue and animation-pacing guards, scene pacing, overlay readability, and motion-mode behavior.
