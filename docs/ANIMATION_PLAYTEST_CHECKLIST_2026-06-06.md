...
- Version: `0.134.0`
- Focus: 2D actor/sprite timeline, blocked-action feedback, CI-backed animation gates, automated actor-readability and visual-fatigue guards, scene pacing, overlay readability, and motion-mode behavior.
