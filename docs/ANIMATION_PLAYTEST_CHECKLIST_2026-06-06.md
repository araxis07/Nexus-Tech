...
- Report draft guard: `draft-animation-playtest-report --output /tmp/nexus-tech-animation-playtest-report.md` writes the validator-required manual report rows before the human pass starts.
