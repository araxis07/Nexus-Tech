...
signoff work, includes the manual observation checklist plus defect intake, and
validates against the execution guide plus issue backlog before the packet is
used.
