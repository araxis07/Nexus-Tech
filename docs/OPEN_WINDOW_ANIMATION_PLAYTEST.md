...
for pause, resume, back/escape, menu return, and help/hover paths, adds exit
criteria, evidence capture prompts, and note templates, and validates against
the execution guide plus issue backlog before the packet is used.
