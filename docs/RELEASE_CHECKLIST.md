...
- Use `docs/OPEN_WINDOW_ANIMATION_PLAYTEST.md` and `docs/ANIMATION_PLAYTEST_CHECKLIST_2026-06-06.md` for the remaining open-window readability pass before presenting the 2D build.
